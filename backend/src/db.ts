...
export { getDbPool };
export type { CountRow, DbPool, ResultSetHeader, RowDataPacket } from './db/types';
...
// NOTE (Phase 0) : ~900 lignes de donnees de demonstration etaient conservees
// ici en commentaire apres la purge du 07/09 (plaintes GRM, fournisseurs,
// organisations, activites, risques, provinces, rapports Power BI, profil OT,
// missions de supervision). Elles sont supprimees du fichier ; l'historique
// git les conserve integralement. Le jeu de demonstration prevu en Phase 0
// sera reconstruit a partir du cadre reel, du PTBA reel et d'un RNA anonymise.
